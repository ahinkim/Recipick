...
public class WishRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue1 = Volley.newRequestQueue(WishRecipeActivity.this);
        ...
        RequestQueue requestQueue3 = Volley.newRequestQueue(WishRecipeActivity.this);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                Intent intent = new Intent( WishRecipeActivity.this, GradeActivity.class );
                ...
                StringRequest IdRequest = new StringRequest(Request.Method.GET, IdUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(UserId.equals(item.getUserId())){
                                Log.d("same","same");
                                Intent intent = new Intent( WishRecipeActivity.this, GradeModifyActivity.class );
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (networkResponse.statusCode == 411) {
                            ...
                            //login 화면으로 돌아가기
                            Intent intent = new Intent( WishRecipeActivity.this, LoginActivity.class );
                            startActivity( intent );
                            finish();
                        } else {
                            Log.d("statuscode", "" + networkResponse.statusCode);
